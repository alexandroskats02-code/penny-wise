...
const ErrorPage = () => {
  return (
    ...
    <h1 className="!text-red-500  text-4xl  " >Ooopss!! Something went wrong!!</h1>
    {/* OUR CHARACTER INSTEAD OF IMAGE */}
    <img className='h-10 ' src={LessonArtwork} alt='something'/>
 
  <p  className='text-sky-400 '>Maybe a fresh start --{">"} <Link to="/" className='underline'> Landing Page</Link></p>
   </div> 
  )
}
